...
The provided dataset was generated by monitoring the execution of several MLlib algorithms on different input datasets, covering the main data mining tasks, i.e. classification, clustering, and association rules. The monitored executions was performed using ```Spark 3.0.1``` on a cluster node equipped with an AMD processor with 64 cores and 256 GB of RAM. Monitoring was performed through the Spark APIs.
